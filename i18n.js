...
(function (global) {
  ...
  const EN = {
    ...
    'common.confirm.title'  : 'Please confirm',
    'common.prompt.title'   : 'Enter a name',
    ...
    'launcher.opencalib'    : 'Open Motor Calibration ↗',
    'launcher.calib.blocked': 'Motor calibration is running — your browser just blocked the new tab.\n\nUse the "Open Motor Calibration" button at the top of this page instead. That one always works.',
    ...
    'launcher.settings.voice.title'  : '🗣 Voice — Microsoft Azure Speech',
    'launcher.settings.voice.hint'   : 'Does both the listening and the speaking. Get a key at portal.azure.com → Speech service.',
    'launcher.settings.voice.key'    : 'Speech key',
    'launcher.settings.voice.region' : 'Region',
    'launcher.settings.voice.regionhint': 'The region shown on the Azure page the key came from — for example eastus. A right key with the wrong region fails.',

    'launcher.settings.brain.title'  : '🧠 Brain — the AI that answers',
    'launcher.settings.brain.hint'   : 'Writes what Yobot says back. All of these understand the same kind of request, so switching between them is just a different address — nothing else about the robot changes.',
    'launcher.settings.brain.key'    : 'API key',
    'launcher.settings.brain.provider'   : 'Who does the thinking',
    'launcher.settings.brain.key.optional': 'API key (usually not needed)',
    'launcher.settings.brain.nokey'      : 'Usually left blank for a server you run yourself',
    'launcher.settings.brain.where'      : 'Get a key here: {where}',
    'launcher.settings.brain.address'    : 'Server address',
    'launcher.settings.brain.addresshint': 'The machine running the model, ending in /v1. If it is not this machine, use its network name or IP — and check the server is set to accept connections from other machines.',
    'launcher.settings.brain.model'      : 'Model',
    'launcher.settings.brain.modelhint'  : 'Pick one from the list, or type any name — the list is only a suggestion. Model names change every few months, so if the one you type does not exist, Test will tell you which ones do.',
    'launcher.settings.brain.modeldefault': 'Leave blank for {model}',
    'launcher.settings.testai'           : 'Test the AI',

    'launcher.settings.test'         : 'Test this key',
    'launcher.settings.testing'      : 'Testing…',
    'launcher.settings.saved.placeholder': 'Already saved: {masked} — leave blank to keep it',
    'launcher.settings.empty.placeholder': 'Not set yet — paste your key here',

    'launcher.settings.advanced'     : 'Advanced',
    'launcher.settings.mic'          : 'Microphone (Raspberry Pi only)',
    'launcher.settings.mic.hint'     : 'Leave blank to let the robot find the microphone itself. If Yobot greets people and then goes deaf, it is listening to the wrong sound card — try plughw:2,0 or plughw:3,0.',
    'launcher.settings.pw.change'    : 'Change the settings password',
    'launcher.settings.pw.changehint': 'Leave blank to keep the current one.',

    'launcher.settings.save'         : '💾 Save',
    'launcher.settings.saving'       : 'Saving…',
    'launcher.settings.close'        : 'Close',
    'launcher.settings.savedok'      : 'Saved.',
    'launcher.settings.nochange'     : 'Nothing to save — no boxes were filled in.',
    'launcher.settings.savefail'     : 'Could not save. {error}',
    'launcher.settings.readfail'     : 'Could not read the settings.',

    'launcher.settings.restart.ask'  : 'Saved. The {running} is running and is still using the old keys — every program reads them once, when it starts. Restart it now so the new keys take effect?',
    'launcher.settings.restart.yes'  : 'Restart now',
    'launcher.settings.restarting'   : 'Restarting…',
    'launcher.settings.restarted'    : 'Restarted — the new keys are live.',
    'launcher.settings.restartfail'  : 'Could not restart it. Press "Stop Current Service" and start it again by hand.',

    'launcher.settings.lock.msg'     : 'Enter the settings password to see or change the keys.',
    'launcher.settings.lock.pw'      : 'Password',
    'launcher.settings.lock.unlock'  : 'Unlock',
    'launcher.settings.lock.wrong'   : 'Wrong password.',
    'launcher.settings.lock.create.msg' : 'Anybody on this WiFi can open this page. Choose a password so only you can see or change the keys. Write it down — the only way back in is to edit the .env file on the Pi.',
    'launcher.settings.lock.create.pw'  : 'New password',
    'launcher.settings.lock.create.pw2' : 'Type it again',
    'launcher.settings.lock.create.btn' : 'Set password',
    'launcher.settings.lock.create.skip': 'Not now — leave the settings unprotected',
    'launcher.settings.lock.tooshort'   : 'Use at least 4 characters.',
    'launcher.settings.lock.mismatch'   : 'The two passwords do not match.',

    'launcher.name.greeter'     : 'Greeter Bot',
    'launcher.name.gui'         : 'Sequence Builder',
    'launcher.name.calibration' : 'Motor Calibration',
    ...
    'gui.speech.ph'         : 'Type what Yobot should say…',
    ...
    'gui.chat.greeting'     : 'Hi! I\'m Yobot 🤖 Type a message and I\'ll respond — check "Speak" to hear me say it!',
    'gui.chat.ph'           : 'Ask Yobot something…',
    ...
    'gui.chat.personality.tip' : 'Yobot\'s personality',
    ...
    'gui.toast.needspeech'  : 'Type something for Yobot to say first!',
    ...
    /* ── Show page and cue editor (added 2026-09-09) ── */
    "show.title"              : "Yobot — Show",
    "show.tab.speech"         : "Speech",
    "show.tab.qa"             : "Q & A",
    "show.speaks"             : "Yobot speaks",
    "show.next.press"         : "Press Return",
    "show.next.speaking"      : "Speaking…",
    "show.next.again"         : "Tap ↺ to run it again",
    "show.next.done"          : "Speech complete",
    "show.startover"          : "↺ Start over",
    "show.of"                 : "{done} of {total}",
    "show.rest"               : "↩ Rest position",
    "show.refresh"            : "⟳ Refresh",
    "show.edit"               : "✎ Edit the cues",
    "show.loading"            : "Loading…",
    "show.ready"              : "Ready. Works with the wifi off.",
    "show.rested"             : "Rest position.",
    "show.top"                : "Back to the top.",
    "show.notrec"             : "NOT RECORDED",
    "show.missing"            : "{n} line(s) not recorded yet",
    "show.norobot"            : "Robot not found — Yobot will talk but not move.",
    "show.noserver"           : "Cannot reach the show server. Is it still running?",
    "show.lost"               : "Lost contact with the show server.",
    "show.failed"             : "That cue did not play.",
    "show.calib"              : "Calibration: {name}",
    "show.calib.none"         : "No calibration file found. The robot is moving on generic limits, not its measured ones. Load a robot in the Launcher, then restart this program.",
    "show.calib.stale"        : "The calibration changed since this started. This program is still using {name}. Quit and start it again, or the robot will move wrong.",
    "show.keys"               : "return next · 1–9 jump · R rest · S/Q tabs",
    "editor.title"            : "Edit what Yobot says",
    "editor.intro"            : "Change the words, add a new one, or remove one you no longer need. Nothing takes effect until you press Save.",
    "editor.back"             : "← Back to the show",
    "editor.add"              : "+ Add",
    "editor.save"             : "Save",
    "editor.saving"           : "Saving…",
    "editor.saved"            : "Saved. {count} cues. A copy of the old version was kept.",
    "editor.unsaved"          : "You have unsaved changes.",
    "editor.leave"            : "Leave without saving?",
    "editor.record"           : "🎙 Record the new lines",
    "editor.record.need"      : "Recording needs the internet. Do it here at the Clubhouse, before you travel.",
    "editor.record.busy"      : "Recording…",
    "editor.record.ok"        : "Recorded. You can switch the wifi off now.",
    "editor.record.fail"      : "Recording failed. Check that this computer is online.",
    "editor.record.save1"     : "Save your changes first, then record.",
    "editor.f.label"          : "Button",
    "editor.f.says"           : "Yobot says",
    "editor.f.motion"         : "Movement",
    "editor.f.group"          : "Section",
    "editor.f.lock"           : "Always Spanish",
    "editor.f.lock.tip"       : "Use for a line that must stay Spanish even when the show is set to English.",
    "editor.ph.label"         : "Short name for the button",
    "editor.ph.says"          : "The whole sentence Yobot will say",
    "editor.up"               : "Move up",
    "editor.down"             : "Move down",
    "editor.del"              : "Delete",
    "editor.del.sure"         : "Delete “{name}”?",
    "editor.recorded"         : "recorded",
    "editor.notrecorded"      : "not recorded",
    "editor.newcue"           : "New button",
    "editor.count"            : "{n} buttons",
    "editor.busy"             : "Yobot is speaking. Wait for him to finish, then save.",
    "editor.loadfail"         : "Could not load the cues.",
    "editor.err.title"        : "Not saved — please fix these first:",
    "editor.err.row"          : "Button {n}: ",
    "editor.err.shape"        : "something is wrong with this row",
    "editor.err.empty"        : "there has to be at least one button",
    "editor.err.toomany"      : "too many buttons (limit {extra})",
    "editor.err.badid"        : "its internal name has odd characters",
    "editor.err.dupid"        : "two buttons share an internal name",
    "editor.err.notext"       : "it has no words for Yobot to say",
    "editor.err.nolabel"      : "it has no name on the button",
    "editor.err.toolong"      : "the text is far too long",
    "editor.err.badmotion"    : "the movement “{extra}” does not exist",
    "editor.err.badlock"      : "the language setting is not valid",

    "show.k.next"             : "next",
    "show.k.jump"             : "jump",
    "show.k.rest"             : "rest",
    "show.k.tabs"             : "tabs",
    "show.nospeech"           : "No speech yet. Build one with “Edit the cues” — each part becomes a button you fire in order.",
  };
  ...
  const ES = {
    ...
    'common.prompt.title'   : 'Escribe un nombre',
    'common.notice.title'   : 'Aviso',
    ...
    'launcher.opencalib'    : 'Abrir calibración de motores ↗',
    'launcher.calib.blocked': 'La calibración de motores está funcionando — tu navegador acaba de bloquear la pestaña nueva.\n\nUsa el botón «Abrir calibración de motores» en la parte superior de esta página. Ese siempre funciona.',
    ...
    'launcher.settings.voice.title'  : '🗣 Voz — Microsoft Azure Speech',
    'launcher.settings.voice.hint'   : 'Se encarga de escuchar y de hablar. Consigue una clave en portal.azure.com → Speech service.',
    'launcher.settings.voice.key'    : 'Clave de voz',
    'launcher.settings.voice.region' : 'Región',
    'launcher.settings.voice.regionhint': 'La región que aparece en la página de Azure de donde sacaste la clave — por ejemplo eastus. Una clave correcta con la región equivocada también falla.',

    'launcher.settings.brain.title'  : '🧠 Cerebro — la IA que responde',
    'launcher.settings.brain.hint'   : 'Escribe lo que Yobot contesta. Todas entienden el mismo tipo de petición, así que cambiar de una a otra es solo una dirección distinta — nada más del robot cambia.',
    'launcher.settings.brain.key'    : 'Clave API',
    'launcher.settings.brain.provider'   : 'Quién piensa',
    'launcher.settings.brain.key.optional': 'Clave API (normalmente no hace falta)',
    'launcher.settings.brain.nokey'      : 'Normalmente se deja en blanco para un servidor propio',
    'launcher.settings.brain.where'      : 'Consigue una clave aquí: {where}',
    'launcher.settings.brain.address'    : 'Dirección del servidor',
    'launcher.settings.brain.addresshint': 'La máquina que ejecuta el modelo, terminando en /v1. Si no es esta máquina, usa su nombre de red o su IP — y comprueba que el servidor acepte conexiones de otras máquinas.',
    'launcher.settings.brain.model'      : 'Modelo',
    'launcher.settings.brain.modelhint'  : 'Elige uno de la lista o escribe cualquier nombre — la lista es solo una sugerencia. Los nombres de los modelos cambian cada pocos meses, así que si el que escribes no existe, Probar te dirá cuáles sí.',
    'launcher.settings.brain.modeldefault': 'Déjalo en blanco para usar {model}',
    'launcher.settings.testai'           : 'Probar la IA',

    'launcher.settings.test'         : 'Probar esta clave',
    'launcher.settings.testing'      : 'Probando…',
    'launcher.settings.saved.placeholder': 'Ya guardada: {masked} — déjalo en blanco para conservarla',
    'launcher.settings.empty.placeholder': 'Sin configurar — pega tu clave aquí',

    'launcher.settings.advanced'     : 'Avanzado',
    'launcher.settings.mic'          : 'Micrófono (solo Raspberry Pi)',
    'launcher.settings.mic.hint'     : 'Déjalo en blanco para que el robot busque el micrófono solo. Si Yobot saluda y después se queda sordo, está escuchando la tarjeta de sonido equivocada — prueba plughw:2,0 o plughw:3,0.',
    'launcher.settings.pw.change'    : 'Cambiar la contraseña de ajustes',
    'launcher.settings.pw.changehint': 'Déjalo en blanco para conservar la actual.',

    'launcher.settings.save'         : '💾 Guardar',
    'launcher.settings.saving'       : 'Guardando…',
    'launcher.settings.close'        : 'Cerrar',
    'launcher.settings.savedok'      : 'Guardado.',
    'launcher.settings.nochange'     : 'No hay nada que guardar — no se rellenó ninguna casilla.',
    'launcher.settings.savefail'     : 'No se pudo guardar. {error}',
    'launcher.settings.readfail'     : 'No se pudieron leer los ajustes.',

    'launcher.settings.restart.ask'  : 'Guardado. {running} está funcionando y todavía usa las claves antiguas — cada programa las lee una sola vez, al arrancar. ¿Reiniciarlo ahora para que use las nuevas?',
    'launcher.settings.restart.yes'  : 'Reiniciar ahora',
    'launcher.settings.restarting'   : 'Reiniciando…',
    'launcher.settings.restarted'    : 'Reiniciado — las claves nuevas ya están en uso.',
    'launcher.settings.restartfail'  : 'No se pudo reiniciar. Pulsa "Detener el servicio actual" y vuelve a arrancarlo a mano.',

    'launcher.settings.lock.msg'     : 'Escribe la contraseña de ajustes para ver o cambiar las claves.',
    'launcher.settings.lock.pw'      : 'Contraseña',
    'launcher.settings.lock.unlock'  : 'Desbloquear',
    'launcher.settings.lock.wrong'   : 'Contraseña incorrecta.',
    'launcher.settings.lock.create.msg' : 'Cualquiera en esta red WiFi puede abrir esta página. Elige una contraseña para que solo tú puedas ver o cambiar las claves. Apúntala — la única forma de recuperarla es editar el archivo .env en la Pi.',
    'launcher.settings.lock.create.pw'  : 'Contraseña nueva',
    'launcher.settings.lock.create.pw2' : 'Escríbela otra vez',
    'launcher.settings.lock.create.btn' : 'Poner contraseña',
    'launcher.settings.lock.create.skip': 'Ahora no — dejar los ajustes sin protección',
    'launcher.settings.lock.tooshort'   : 'Usa al menos 4 caracteres.',
    'launcher.settings.lock.mismatch'   : 'Las dos contraseñas no coinciden.',

    'launcher.name.greeter'     : 'el Saludador',
    'launcher.name.gui'         : 'el Constructor de secuencias',
    'launcher.name.calibration' : 'la Calibración de motores',
    ...
    'gui.speech.ph'         : 'Escribe lo que Yobot debe decir…',
    ...
    'gui.chat.greeting'     : '¡Hola! Soy Yobot 🤖 Escribe un mensaje y te respondo. Marca «Hablar» para oírme decirlo.',
    'gui.chat.ph'           : 'Pregúntale algo a Yobot…',
    ...
    'gui.chat.personality.tip' : 'La personalidad de Yobot',
    ...
    'gui.toast.needspeech'  : '¡Escribe primero algo para que Yobot lo diga!',
    ...
    /* ── Show page and cue editor (added 2026-09-09) ── */
    "show.title"              : "Yobot — Función",
    "show.tab.speech"         : "Discurso",
    "show.tab.qa"             : "Preguntas",
    "show.speaks"             : "Yobot habla",
    "show.next.press"         : "Pulsa Intro",
    "show.next.speaking"      : "Hablando…",
    "show.next.again"         : "Pulsa ↺ para empezar de nuevo",
    "show.next.done"          : "Discurso terminado",
    "show.startover"          : "↺ Empezar de nuevo",
    "show.of"                 : "{done} de {total}",
    "show.rest"               : "↩ Posición de reposo",
    "show.refresh"            : "⟳ Actualizar",
    "show.edit"               : "✎ Editar los textos",
    "show.loading"            : "Cargando…",
    "show.ready"              : "Listo. Funciona con el wifi apagado.",
    "show.rested"             : "Posición de reposo.",
    "show.top"                : "De vuelta al principio.",
    "show.notrec"             : "SIN GRABAR",
    "show.missing"            : "{n} frase(s) sin grabar todavía",
    "show.norobot"            : "No se encuentra el robot — Yobot hablará pero no se moverá.",
    "show.noserver"           : "No se puede contactar con el programa. ¿Sigue abierto?",
    "show.lost"               : "Se perdió el contacto con el programa.",
    "show.failed"             : "Ese texto no se reprodujo.",
    "show.calib"              : "Calibración: {name}",
    "show.calib.none"         : "No se encontró el archivo de calibración. El robot se mueve con límites genéricos, no con los suyos medidos. Carga un robot en el Lanzador y reinicia este programa.",
    "show.calib.stale"        : "La calibración cambió después de arrancar. Este programa sigue usando {name}. Ciérralo y ábrelo otra vez, o el robot se moverá mal.",
    "show.keys"               : "Intro siguiente · 1–9 saltar · R reposo · S/Q pestañas",
    "editor.title"            : "Editar lo que dice Yobot",
    "editor.intro"            : "Cambia las palabras, añade una nueva o quita una que ya no necesites. Nada tiene efecto hasta que pulses Guardar.",
    "editor.back"             : "← Volver a la función",
    "editor.add"              : "+ Añadir",
    "editor.save"             : "Guardar",
    "editor.saving"           : "Guardando…",
    "editor.saved"            : "Guardado. {count} textos. Se conservó una copia de la versión anterior.",
    "editor.unsaved"          : "Tienes cambios sin guardar.",
    "editor.leave"            : "¿Salir sin guardar?",
    "editor.record"           : "🎙 Grabar las frases nuevas",
    "editor.record.need"      : "Grabar necesita internet. Hazlo aquí en el Clubhouse, antes de viajar.",
    "editor.record.busy"      : "Grabando…",
    "editor.record.ok"        : "Grabado. Ya puedes apagar el wifi.",
    "editor.record.fail"      : "La grabación falló. Comprueba que esta computadora tenga internet.",
    "editor.record.save1"     : "Guarda primero tus cambios y después graba.",
    "editor.f.label"          : "Botón",
    "editor.f.says"           : "Yobot dice",
    "editor.f.motion"         : "Movimiento",
    "editor.f.group"          : "Sección",
    "editor.f.lock"           : "Siempre en español",
    "editor.f.lock.tip"       : "Úsalo para una frase que debe quedarse en español aunque la función esté en inglés.",
    "editor.ph.label"         : "Nombre corto del botón",
    "editor.ph.says"          : "La frase completa que dirá Yobot",
    "editor.up"               : "Subir",
    "editor.down"             : "Bajar",
    "editor.del"              : "Borrar",
    "editor.del.sure"         : "¿Borrar «{name}»?",
    "editor.recorded"         : "grabado",
    "editor.notrecorded"      : "sin grabar",
    "editor.newcue"           : "Botón nuevo",
    "editor.count"            : "{n} botones",
    "editor.busy"             : "Yobot está hablando. Espera a que termine y guarda.",
    "editor.loadfail"         : "No se pudieron cargar los textos.",
    "editor.err.title"        : "No se guardó — corrige esto primero:",
    "editor.err.row"          : "Botón {n}: ",
    "editor.err.shape"        : "algo está mal en esta fila",
    "editor.err.empty"        : "tiene que haber al menos un botón",
    "editor.err.toomany"      : "demasiados botones (máximo {extra})",
    "editor.err.badid"        : "su nombre interno tiene caracteres extraños",
    "editor.err.dupid"        : "dos botones comparten el nombre interno",
    "editor.err.notext"       : "no tiene palabras para que Yobot las diga",
    "editor.err.nolabel"      : "no tiene nombre en el botón",
    "editor.err.toolong"      : "el texto es demasiado largo",
    "editor.err.badmotion"    : "el movimiento «{extra}» no existe",
    "editor.err.badlock"      : "el ajuste de idioma no es válido",

    "show.k.next"             : "siguiente",
    "show.k.jump"             : "saltar",
    "show.k.rest"             : "reposo",
    "show.k.tabs"             : "pestañas",
    "show.nospeech"           : "Todavía no hay discurso. Crea uno con «Editar los textos» — cada parte será un botón que aprietas en orden.",
  };
